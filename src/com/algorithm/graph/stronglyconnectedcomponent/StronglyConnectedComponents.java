...
public class StronglyConnectedComponents {
  ...
  public static void stronglyConnectedComponents(Map<Vertex, List<Vertex>> graph) {
  ...
  private static void DFS_VISIT(Map<Vertex, List<Vertex>> graph, Vertex u, Stack<Vertex> s) {
    TIME = TIME + 1;
    u.d = TIME;
    u.c = Color.GRAY;
   ...
   */
  private static void DFS_MODIFIED(Map<Vertex, List<Vertex>> graphT, Stack<Vertex> s) {
